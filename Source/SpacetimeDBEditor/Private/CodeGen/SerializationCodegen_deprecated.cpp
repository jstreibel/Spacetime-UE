#include "SerializationCodegen_deprecated.h"
...
{
	bool FSerializationCodegen_deprecated::GenerateSerializationCode(
	...
	bool FSerializationCodegen_deprecated::SerializeAlgebraicType(
	...
	{	
		...
		default:
			...
			UE_LOG(LogTemp, Error, TEXT("[SpacetimeDB] Unsupported type: %s"), *SpacetimeDB::TypeToString(TypeEntry.Type));
			break;
		}
	...
	void FSerializationCodegen_deprecated::GenerateProductSerializationCode(
	...
	void FSerializationCodegen_deprecated::GenerateSumSerializationCode(
	...
	void FSerializationCodegen_deprecated::GenerateFunctionCall(
		...
		const int Indent)
	{
		...
		if (!ProductField.Name.IsSet())
		{
			...
			UE_LOG(LogTemp, Error, TEXT("[SpacetimeDB] Internal error: unhandled missing name for field in product type"));
			return;
		}
